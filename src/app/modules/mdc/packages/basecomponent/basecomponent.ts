...
export class BaseComponent {
    ...
    prop = null;
    name = null;
    public _nativeElement = null;
    public _inputElement = null;
    public _mdcComponent = null;
    constructor(private _formService: FormService, private _ngZone: NgZone) {
